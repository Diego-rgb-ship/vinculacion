...
@section('title1')
<a href="{{route('seguimiento.indexla')}}" style="color: #59152f;">Alumnos de LADMON: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('seguimiento.indexlamujeres')}}" style="color: #59152f;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('seguimiento.indexlahombres')}}" style="color: #59152f;">Hombres: {{$hombres}}</a>
@endsection
