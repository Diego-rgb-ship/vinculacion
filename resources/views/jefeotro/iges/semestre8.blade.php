...
@section('title1')
<a href="{{route('seguimiento.indexigess8')}}" style="color: #59152f;">Alumnos de IGES semestre 8: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('seguimiento.indexigess8mujeres')}}" style="color: #59152f;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('seguimiento.indexigess8hombres')}}" style="color: #59152f;">Hombres: {{$hombres}}</a>
@endsection
