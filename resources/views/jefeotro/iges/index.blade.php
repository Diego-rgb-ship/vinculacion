...
@section('title1')
<a href="{{route('seguimiento.indexiges')}}" style="color: #59152f;">Alumnos de IGES: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('seguimiento.indexigesmujeres')}}" style="color: #59152f;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('seguimiento.indexigeshombres')}}" style="color: #59152f;">Hombres: {{$hombres}}</a>
@endsection
